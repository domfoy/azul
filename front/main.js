...
var author$project$Main$Ba = {$: 'Ba'};
var author$project$Main$Bu = {$: 'Bu'};
...
var author$project$Main$colourDecoder = A2(
	elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'Bu':
				return elm$json$Json$Decode$succeed(author$project$Main$Bu);
			case 'Y':
				return elm$json$Json$Decode$succeed(author$project$Main$Y);
			case 'R':
				return elm$json$Json$Decode$succeed(author$project$Main$R);
			case 'Ba':
				return elm$json$Json$Decode$succeed(author$project$Main$Ba);
			case 'W':
				return elm$json$Json$Decode$succeed(author$project$Main$W);
			default:
				var otherValue = str;
				return elm$json$Json$Decode$fail('Unknown colour: ' + otherValue);
		}
	},
	elm$json$Json$Decode$string);
var elm$json$Json$Decode$int = _Json_decodeInt;
var author$project$Main$tileDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'colour',
	author$project$Main$colourDecoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'id',
		elm$json$Json$Decode$int,
		elm$json$Json$Decode$succeed(author$project$Main$Tile)));
var elm$json$Json$Decode$array = _Json_decodeArray;
var author$project$Main$factoryDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'tiles',
	elm$json$Json$Decode$array(author$project$Main$tileDecoder),
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'id',
		elm$json$Json$Decode$int,
...
var author$project$Main$createSocket = _Platform_outgoingPort(
	'createSocket',
	function ($) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'JoinGame') {
			return _Utils_Tuple2(
				model,
				author$project$Main$createSocket(_Utils_Tuple0));
		} else {
			if (msg.a.$ === 'Err') {
				var err = msg.a.a;
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$p,
								_List_Nil,
								author$project$Main$viewGame(model.game))
							]))
					])),
				A2(
